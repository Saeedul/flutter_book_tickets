...
import 'package:flutter_book_tickets/widgets/icon_text_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    child: Center(child: Text("Find tickets", style: Styles.textStyle.copyWith(color: Colors.white,)))
          ...
          Row(
            ...
            children: [
            Container(
              height: AppLayout.getHeight(400), //he gave 425
                ...
                Stack(
                  children: [
                    Container(
                      ...
                      height: AppLayout.getHeight(174),//he gave 200 - 4:24:00
                      decoration: BoxDecoration(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text("Take the survey about our servies and get discount", style: Styles.headLineStyle2.copyWith(fontWeight: FontWeight.w500, color: Colors.white, fontSize: 18),),
                        ],
                      ),
                    ),
                    Positioned(
