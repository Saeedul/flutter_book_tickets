        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              SizedBox(height: AppLayout.getHeight(10), width: AppLayout.getWidth(10)),
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                mainAxisAlignment: MainAxisAlignment.start,
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(height: AppLayout.getHeight(5),width: AppLayout.getWidth(5)),
                        const Text(
                          "Premium status",
                          style: TextStyle(
                              color: Color(0xFF526799),
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    SizedBox(height: AppLayout.getHeight(12), width: AppLayout.getWidth(10),),
                    Column(
                      mainAxisAlignment: MainAxisAlignment.start,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
